  ...
  return _createClass(MessageListInner, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      var _this$props = this.props,
        ...
        keepScrollPosition = _this$props.keepScrollPosition;
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
        ...
        typingIndicator = _this$props2.typingIndicator,
        loading = _this$props2.loading,
        loadingMore = _this$props2.loadingMore,
        loadingMorePosition = _this$props2.loadingMorePosition,
        onYReachStart = _this$props2.onYReachStart,
        onYReachEnd = _this$props2.onYReachEnd,
        className = _this$props2.className,
        disableOnYReachWhenNoScroll = _this$props2.disableOnYReachWhenNoScroll,
        scrollBehavior = _this$props2.scrollBehavior,
        autoScrollToBottom = _this$props2.autoScrollToBottom,
        autoScrollToBottomOnMount = _this$props2.autoScrollToBottomOnMount,
...
MessageList.propTypes = {
  ...
  keepScrollPosition: _propTypes["default"].bool
};
